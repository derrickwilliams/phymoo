...
module.exports = exports = function (grunt) {
    ...
    grunt.initConfig({
        concat: {
            ...
            localforage: {
                files: {
                    ...
                    "bower_components/es6-promise/promise.js", "src/utils/**/*.js", "src/drivers/**/*.js", "src/localforage.js"],
        ...
        shell: {
            ...
            component: {
                command: path.resolve("node_modules", "component", "bin", "component-build") + " --dev -o test -n localforage.component"
            },
            "publish-site": {
