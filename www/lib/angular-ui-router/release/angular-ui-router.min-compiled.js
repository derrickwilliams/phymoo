...
"undefined" != typeof module && "undefined" != typeof exports && module.exports === exports && (module.exports = "ui.router"), (function (a, b, c) {
  "use strict";function d(a, b) {
    ...
    }var c = [];return (b.forEach(a, function (a, b) {
      c.push(b);
    }), c);
  }function h(a, b) {
    if (Array.prototype.indexOf) {
      return a.indexOf(b, Number(arguments[2]) || 0);
        ...
        d = Number(arguments[2]) || 0;for (d = 0 > d ? Math.ceil(d) : Math.floor(d), 0 > d && (d += c); c > d; d++) if (d in a && a[d] === b) {
      return d;
    }return -1;
  }function i(a, b, c, d) {
    var e,
    ...
    function f(b, c, d, e) {
      if ((q.push(b), o[b])) {
        return o[b];
      }if (!/^\w+(-+\w+)*(?:\[\])?$/.test(b)) throw new Error("Invalid parameter name '" + b + "' in pattern '" + a + "'");if (p[b]) throw new Error("Duplicate parameter name '" + b + "' in pattern '" + a + "'");return (p[b] = new O.Param(b, c, d, e), p[b]);
    }function g(a, b, c) {
      var d = ["", ""],
          e = a.replace(/[\\\[\]\^$*+?.()|{}]/g, "\\$&");if (!b) {
        return e;
    ...
    function a(a) {
      ...
      M(this, a || {});
        ...
        y = { string: { encode: a, decode: e, is: f, pattern: /[^/]*/ }, int: { encode: a, decode: function decode(a) {
          ...
          if (this.is(a)) {
            return a;
          }var b = this.capture.exec(a);return b ? new Date(b[1], b[2] - 1, b[3]) : c;
        }, is: function is(a) {
    ...
    function e(a) {
      ...
      if (!c) {
        return !1;
      }var d = a.invoke(b, b, { $match: c });return G(d) ? d : !0;
    }function h(d, e, f, g) {
      function h(a, b, c) {
        ...
        function b(a) {
          ...
          var e = o && d.url() === o;if ((o = c, e)) {
            return !0;
          }var g,
              h = j.length;for (g = 0; h > g; g++) if (b(j[g])) {
            return;
          }k && b(k);
        }
      }function n() {
        return i = i || e.$on("$locationChangeSuccess", m);
          ...
          if (!c.validates(e)) {
            return null;
          }var g = a.html5Mode();b.isObject(g) && (g = g.enabled);var i = c.format(e);if ((f = f || {}, g || null === i || (i = "#" + a.hashPrefix() + i), i = h(i, g, f.absolute), !f.absolute || !i)) {
            return i;
          }var j = !g && i ? "/" : "",
    ...
    function f(a) {
      ...
      b = d(b, { self: b, resolve: b.resolve || {}, toString: function toString() {
          return this.name;
        } });var c = b.name;if (!I(c) || c.indexOf("@") >= 0) throw new Error("State must have a valid name");if (y.hasOwnProperty(c)) throw new Error("State '" + c + "'' is already defined");var e = -1 !== c.indexOf(".") ? c.substring(0, c.lastIndexOf(".")) : I(b.parent) ? b.parent : J(b.parent) && I(b.parent.name) ? b.parent.name : "";if (e && !y[e]) {
        return m(e, b.self);
      }for (var f in B) H(B[f]) && (b[f] = B[f](b, B.$delegates[f]));return (y[c] = b, !b[A] && b.url && a.when(b.url, ["$match", "$stateParams", function (a, c) {
      ...
      var b = a.split("."),
          c = x.$current.name.split(".");if (("**" === b[0] && (c = c.slice(h(c, b[1])), c.unshift("**")), "**" === b[b.length - 1] && (c.splice(h(c, b[b.length - 2]) + 1, Number.MAX_VALUE), c.push("**")), b.length != c.length)) {
        return !1;
      ...
      function s(b, c, d, f) {
        var g = a.$broadcast("$stateNotFound", b, c, d);if (g.defaultPrevented) {
          return (p.update(), B);
        }if (!g.retry) {
          return null;
        }if (f.$retry) {
          return (p.update(), C);
        }var h = x.transition = e.when(g.retry);return (h.then(function () {
