...
var app = angular.module("phymoo.controllers", ["ionic"]);

app.controller("DashCtrl", ["$ionicModal", "phymooData", "$scope", "$filter", DashCtrl]);
...
app.controller("SettingsCtrl", ["phymooData", SettingsCtrl]);
...
function SettingsCtrl(phymooData) {
  ...
  phymooData.load("testData").then(function (data) {
